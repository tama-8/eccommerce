# -*- encoding: utf-8 -*-
# stub: acts-as-taggable-on 11.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<activerecord>.freeze, [">= 7.0", "< 8.0"])
    ...
    s.add_dependency(%q<activerecord>.freeze, [">= 7.0", "< 8.0"])
    s.add_dependency(%q<zeitwerk>.freeze, [">= 2.4", "< 3.0"])
